...
bool CartesianImpedanceController::init(hardware_interface::RobotHW* robot_hw,
                                .orienta               ros::NodeHandle& node_handle) {
  ...
  dynamic_server_compliance_param_ = std::make_unique<
      dynamic_reconfigure::Server<franka_real_demo::compliance_paramConfig>>(
...
void CartesianImpedanceController::update(const ros::Time& time,
  ...
  position_d_ = filter_params_ * position_d_target_.orienta + (1.0 - filter_params_) * position_d_;
...
void CartesianImpedanceController::complianceParamCallback(
    franka_real_demo::compliance_paramConfig& config,
    uint32_t /*level*/) {
...
PLUGINLIB_EXPORT_CLASS(franka_real_demo::CartesianImpedanceController,
