...
#include <franka_real_demo/compliance_paramConfig.h>
#include <franka_hw/franka_model_interface.h>
#include <franka_hw/franka_state_interface.h>
#include <realtime_tools/realtime_publisher.h>
#include <franka_real_demo/ZeroJacobian.h>

namespace franka_real_demo {
...
class CartesianImpedanceController : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  // Dynamic reconfigure
  std::unique_ptr<dynamic_reconfigure::Server<franka_real_demo::compliance_paramConfig>>
      dynamic_server_compliance_param_;
  ros::NodeHandle dynamic_reconfigure_compliance_param_node_;
  void complianceParamCallback(franka_real_demo::compliance_paramConfig& config,
                               uint32_t level);
  void publishZeroJacobian(const ros::Time& time);
  realtime_tools::RealtimePublisher<franka_real_demo::ZeroJacobian> publisher_franka_jacobian_;
...
}  // namespace franka_real_demo.orienta